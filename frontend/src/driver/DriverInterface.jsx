...
const navItems = [
  { name: "Home", icon: <Home size={20} />, path: "/driver" },
  { name: "All Buses", icon: <Bus size={20} />, path: "/driver/buses" },
  { name: "Support", icon: <HelpCircle size={20} />, path: "/driver/support" },
  { name: "Profile", icon: <User size={20} />, path: "/driver/profile-page" },
];
